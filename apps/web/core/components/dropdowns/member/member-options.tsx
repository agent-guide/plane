...
export const MemberOptions = observer(function MemberOptions(props: Props) {
  ...
  return createPortal(
    // headlessui v2 clones child elements for aria wiring and drops consumer
    // refs in the process (the anchor never attached — panels sat at 0,0).
    // Attach popper to the ul that headlessui itself renders instead.
    <Combobox.Options
      as="ul"
